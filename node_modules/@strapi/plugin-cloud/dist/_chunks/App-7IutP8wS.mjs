...
import { p as pluginId } from "./index-kFs-oE1V.mjs";
...
const CloudBox = () => {
  ...
  return /* @__PURE__ */ jsx(Box, { padding: 4, hasRadius: true, children: /* @__PURE__ */ jsxs(Flex, { alignItems: "center", direction: "column", padding: 11, hasRadius: true, children: [
    ...
    /* @__PURE__ */ jsx(Box, { paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "beta", as: "p", textAlign: "center", textColor: "neutral1000", children: formatMessage({
      id: getTrad("Homepage.cloudBox.title"),
      defaultMessage: "Deploy to Strapi Cloud"
    }) }) }),
    /* @__PURE__ */ jsx(Typography, { variant: "epsilon", as: "p", textAlign: "center", textColor: "neutral600", children: formatMessage({
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsxs(Box, { paddingLeft: 10, paddingRight: 10, children: [
    ...
    /* @__PURE__ */ jsxs(Box, { paddingLeft: 10, paddingRight: 10, paddingBottom: 8, paddingTop: 10, children: [
      /* @__PURE__ */ jsx(Flex, { justifyContent: "space-between", alignItems: "center", direction: "column", children: /* @__PURE__ */ jsx(Flex, { minWidth: 0, children: /* @__PURE__ */ jsx(Typography, { as: "h1", variant: "alpha", children: formatMessage({
        id: getTrad("Homepage.title"),
        defaultMessage: "Fully-managed Cloud Hosting for your Strapi Project"
      }) }) }) }),
      /* @__PURE__ */ jsx(Flex, { alignItems: "center", direction: "column", children: /* @__PURE__ */ jsx(Typography, { variant: "epsilon", textColor: "neutral600", as: "p", children: formatMessage({
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 10, children: [
      /* @__PURE__ */ jsxs(GridLayout, { children: [
      ...
      /* @__PURE__ */ jsxs(Box, { padding: 6, borderRadius: 8, hasRadius: true, background: "neutral0", borderColor: "neutral200", children: [
        /* @__PURE__ */ jsx(Box, { paddingBottom: 2, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", textColor: "neutral1000", as: "p", children: formatMessage({
          id: getTrad("Homepage.textBox.label.versioned"),
          defaultMessage: "Try Strapi Cloud for Free!"
        }) }) }),
        /* @__PURE__ */ jsxs(Typography, { variant: "epsilon", textColor: "neutral1000", as: "p", children: [
          formatMessage({
...
const App = () => {
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Switch, { children: [
    /* @__PURE__ */ jsx(Route, { path: `/plugins/${pluginId}`, component: HomePage, exact: true }),
...
//# sourceMappingURL=App-7IutP8wS.mjs.map
