...
const ListView$1 = lazy(() => import("./ListView-Sn-3QLno.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-Sn-3QLno.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-pWRoAorE.mjs.map
