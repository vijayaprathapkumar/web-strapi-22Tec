...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-LblG7sy4.mjs";
...
import { u as useWebhooks } from "./useWebhooks-1cD-Wjh6.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-vZK_CTQU.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-lWoNefEi.mjs.map
