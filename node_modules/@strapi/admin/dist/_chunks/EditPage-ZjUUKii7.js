...
const useWebhooks = require("./useWebhooks-WLn3OtSg.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-CV7xm5zl.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-ZjUUKii7.js.map
